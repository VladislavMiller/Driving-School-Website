  ...
  return (
    <header className="site-header">
      ...
      <div className="shell header-inner">
        <Link className="wordmark" href="/" aria-label={`${siteData.business.name}, forsiden`}>
        ...
        <a className="button button-small header-cta" href="/kontakt#formular">{siteData.hero.primaryCta} <Arrow /></a>
      ...
      {open && <nav className="mobile-nav" aria-label="Mobilnavigation">
        ...
        <a className="button" href="/kontakt#formular" onClick={() => setOpen(false)}>{siteData.hero.primaryCta}</a>
      </nav>}
    </header>
  );
}
